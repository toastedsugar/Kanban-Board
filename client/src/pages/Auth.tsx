      ...
      <div className="card bg-base-200 justify-center items-center w-96 shadow-xl">
        <div className="p-12">
          <form
            ...
            onSubmit={auth === "login" ? HandleLogin : HandleRegister}
          >
            <h2 className="mb-4">
            ...
            <ul className="mb-6">
              <li className="flex flex-col mb-2">
                <label className="label-text" htmlFor="usernameInput">Username</label>
                <input
                  id="usernameInput"
              ...
              <li className="flex flex-col">
                <label className="label-text" htmlFor="passwordInput">Password</label>
