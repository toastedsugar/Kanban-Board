...
function NavModal() {
    return (
        <div className="h-screen w-screen brightness-50 fixed top-0 right-0 left-0 flex justify-center items-center">
            <div className="bg-color-surface-mixed-200 w-96 h-96">
                Nav modal
            </div>
        </div>
    )
